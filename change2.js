function torn(cashProduct, cashCustomer) {
  ...
  if (+cashCustomer < +cashProduct) //บวกทำไมวะ
  ...
  let cash = {
    ...
    cash_2: 0,
    cash_1: 0,
  } //มันคือobjข้างในเก็บเป็นproperty name
  ...
  if (charge >= 500) {
    ...
    charge = charge - 500 * Math.floor(charge / 500) //* Re-assign charge ใหม่ //เราเหลืออีกกี่บาทที่ต้องทอนให้ลูกค้า
  } //700-(500*1)

  //* กรณีเงินทอนมากกว่าเท่ากับ 100
  if (charge >= 100) {
    cash['cash_100'] = Math.floor(charge / 100) //คือการอัพเดทค่าให้กับproperty nameของcash
  ...
  return { text: `เงินทอนทั้งหมด ${+cashCustomer - +cashProduct}`, cash }//textคือproperty nameเพื่อให้returnออกไปเป็นobj
}
/*
  Output:
  {
